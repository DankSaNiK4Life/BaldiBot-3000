...
class Config:
    ...
    RANDOM_SOUND_INTERVAL = (10, 20)                        # This is the interval (in seconds) at which random sounds will be played (between 5 minutes and 1 hour)
    ...
    join_vc_audio = "./sounds/BaldiAIVoiceTest.mp3"
